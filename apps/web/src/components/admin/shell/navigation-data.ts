...
export const navItems: NavItem[] = [
  ...
  },
  {
    id: 'inventory', label: 'navigation.inventory', href: '#', icon: 'inventory', children: [
      ...
      { id: 'inv-opening-balances', label: 'navigation.openingBalances', href: '/admin/inventory/opening-balances' },
  ...
  },
  {
    id: 'maintenance', label: 'navigation.maintenance', href: '#', icon: 'maintenance', children: [
      ...
      { id: 'mnt-spare-parts', label: 'navigation.spareParts', href: '/admin/maintenance/spare-parts' },
