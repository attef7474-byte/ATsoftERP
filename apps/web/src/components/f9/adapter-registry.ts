...
const registry: UnifiedSearchEntity[] = [
  ...
  },
  {
    ...
    detailRoute: (item: Warehouse) => `/admin/inventory/warehouses/${item.id}`,
  ...
  },
  {
    ...
    detailRoute: (item: ProductCategory) => `/admin/inventory/product-categories/${item.id}`,
  ...
  },
  {
    ...
    detailRoute: (item: MachineCategory) => `/admin/maintenance/machine-categories/${item.id}`,
  ...
  },
  {
    ...
    detailRoute: (item: Role) => `/admin/access/roles/${item.id}`,
  ...
  },
  {
    ...
    detailRoute: (item: MaintenanceTask) => `/admin/maintenance/tasks/${item.id}`,
  ...
  },
  {
    ...
    detailRoute: (item: MaintenanceSchedule) => `/admin/maintenance/schedules/${item.id}`,
  ...
  },
  {
    ...
    detailRoute: (item: WarehouseLocation) => `/admin/inventory/locations/${item.id}`,
    subtitle: (item: WarehouseLocation) => item.code,
  },
  {
    entityType: 'barcodeLabel',
    labelKey: 'details.machineMaintenanceLog',
    adapter: barcodeLabelAdapter as LookupAdapter<any>,
    detailRoute: (item: BarcodeLabel) => `/admin/barcodes/labels/${item.id}`,
  ...
  },
  {
    ...
    detailRoute: (item: NumberSequence) => `/admin/settings/numbering/${item.id}`,
  ...
  },
  {
    ...
    detailRoute: (item: Notification) => `/admin/notifications/${item.id}`,
  ...
  },
  {
    ...
    detailRoute: (item: AuditLog) => `/admin/settings/audit/${item.id}`,
  ...
  },
  {
    ...
    detailRoute: (item: MachinePart) => `/admin/maintenance/machine-parts/${item.id}`,
  ...
  },
  {
    ...
    detailRoute: (item: DowntimeLog) => `/admin/maintenance/downtime-logs/${item.id}`,
