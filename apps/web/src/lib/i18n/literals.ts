...
export function translatePermissionKey(key: string, locale: Locale): string {
  ...
  const actionAr: Record<string, string> = { create: 'إنشاء', read: 'عرض', manage: 'إدارة', view: 'عرض', update: 'تحديث', edit: 'تعديل', delete: 'حذف', activate: 'تفعيل', deactivate: 'تعطيل', assign: 'تعيين', approve: 'اعتماد', reject: 'رفض', cancel: 'إلغاء', complete: 'إكمال', close: 'إغلاق', block: 'حظر', unblock: 'إلغاء الحظر', analysis: 'تحليل', classify: 'تصنيف', current: 'الحالي', 'reset password': 'إعادة تعيين كلمة المرور', 'end downtime': 'إنهاء التوقف', enddowntime: 'إنهاء التوقف', 'start downtime': 'بدء التوقف', startdowntime: 'بدء التوقف', 'log summary': 'ملخص السجل', logsummary: 'ملخص السجل', bymachine: 'حسب الآلة', 'by machine': 'حسب الآلة', 'by location': 'حسب الموقع', 'by product': 'حسب المنتج', balances: 'الأرصدة', 'change type': 'تغيير النوع', changetype: 'تغيير النوع', 'enter line': 'إدخال السطر', post: 'ترحيل', 'update status': 'تحديث الحالة', updatestatus: 'تحديث الحالة', status: 'الحالة', readall: 'عرض الكل' };
  const actionEn: Record<string, string> = { create: 'Create', read: 'View', view: 'View', update: 'Update', edit: 'Edit', delete: 'Delete', activate: 'Activate', deactivate: 'Deactivate', assign: 'Assign', approve: 'Approve', reject: 'Reject', cancel: 'Cancel', complete: 'Complete', close: 'Close', block: 'Block', unblock: 'Unblock', analysis: 'Analysis', classify: 'Classify', current: 'Current', 'reset password': 'Reset Password', enddowntime: 'End Downtime', startdowntime: 'Start Downtime', logsummary: 'Log Summary', bymachine: 'By Machine', 'by machine': 'By Machine', 'by location': 'By Location', 'by product': 'By Product', balances: 'Balances', changetype: 'Change Type', 'enter line': 'Enter Line', post: 'Post', updatestatus: 'Update Status', status: 'Status', readall: 'View All' };
