...
export function translatePermissionKey(key: string, locale: Locale): string {
  ...
  const moduleAr: Record<string, string> = {
    administration: 'الإدارة', attachment: 'المرفقات', 'audit log': 'سجل التدقيق', inventory: 'المخزون', maintenance: 'الصيانة', production: 'الإنتاج', quality: 'الجودة', organization: 'التنظيم', role: 'الأدوار', user: 'المستخدمون',
