...
const validation: Pick<LocaleTranslations, 'validation' | 'errors' | 'complexForms'> = {
    validation: {
        ...
        passwordWhitespaceOnly: 'Password cannot contain only whitespace.',
        passwordMinLength: 'Password must be at least {min} characters.',
        passwordTooLong: 'Password exceeds the safe bcrypt limit of {maxBytes} bytes.',
    ...
    errors: {
        ...
        unavailable: 'The requested text could not be displayed.',
    },
    complexForms: {
        create: 'Create',
        edit: 'Edit',
