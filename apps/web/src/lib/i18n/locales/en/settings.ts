    ...
    settings: {
        ...
        numbering: {
            ...
            operationNameMap: {
                ...
                SPARE_PART_CONDITION_MOVEMENT: 'Spare Part Condition Movement',
            ...
            modelNameMap: {
                ...
                OPENING_BALANCE: 'InventoryOpeningBalance',
                STOCK_ADJUSTMENT: 'InventoryStockAdjustment',
                PHYSICAL_COUNT: 'InventoryPhysicalCount',
                STOCK_TRANSFER: 'InventoryStockTransfer',
                OPERATIONAL_RECEIPT: 'InventoryOperationalReceipt',
                MACHINE: 'Machine',
                MACHINE_ASSET: 'MachineAsset',
                MACHINE_CATEGORY: 'MachineCategory',
                MACHINE_PART: 'MachinePart',
                MACHINE_DOCUMENT: 'MachineDocument',
                MAINTENANCE_PERSONNEL: 'OperationalPerson',
                ...
                SPARE_PART_REPAIR_ORDER: 'SparePartRepairOrder',
        ...
        company: {
            ...
            operationalCurrencyCode: 'Operational Currency',
            operationalCurrencyDescription: 'ISO-4217 currency used by future operational cost postings. No default or FX conversion is applied.',
            invalidOperationalCurrency: 'Enter a valid ISO-4217 currency code.',
            operationalCurrencyNotConfigured: 'Configure the company operational currency before posting operational costs.',
            inventoryCurrencyMismatch: 'Inventory event currency must match the company operational currency. FX conversion is not supported.',
            operationalCurrencyFrozen: 'Operational currency cannot change after the first operational cost posting.',
