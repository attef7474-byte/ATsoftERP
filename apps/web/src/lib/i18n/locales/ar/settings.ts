...
const settings: Pick<LocaleTranslations, 'settings' | 'notifications' | 'messaging' | 'languageSettings' | 'appearanceSettings' | 'securitySettings' | 'notificationRules'> = {
    settings: {
        ...
        numbering: {
            ...
            operationNameMap: {
                ...
                OPERATIONAL_RECEIPT: 'إيصال تشغيلي',
                MACHINE: 'الماكينة',
                MACHINE_ASSET: 'أصل/معدة',
                MACHINE_CATEGORY: 'تصنيف ماكينة',
                MACHINE_PART: 'قطعة غيار',
                MACHINE_DOCUMENT: 'مستند ماكينة',
                MAINTENANCE_PERSONNEL: 'موظفي الصيانة',
                ...
                SPARE_PART_CONDITION_MOVEMENT: 'حركة حالة قطع الغيار',
        ...
        company: {
            ...
            operationalCurrencyCode: 'عملة التكاليف التشغيلية',
            operationalCurrencyDescription: 'عملة ISO-4217 المستخدمة في ترحيلات التكاليف التشغيلية المستقبلية، دون عملة افتراضية أو تحويل صرف.',
            invalidOperationalCurrency: 'أدخل رمز عملة ISO-4217 صالحًا.',
            operationalCurrencyNotConfigured: 'اضبط عملة التكاليف التشغيلية للشركة قبل ترحيل التكاليف.',
            inventoryCurrencyMismatch: 'يجب أن تطابق عملة حدث المخزون عملة التكاليف التشغيلية للشركة، ولا يوجد تحويل صرف.',
            operationalCurrencyFrozen: 'لا يمكن تغيير عملة التكاليف التشغيلية بعد أول ترحيل تكلفة تشغيلية.',
    ...
    languageSettings: {
        ...
        appearanceSettings: {
            ...
            sidebarAccent: '\u0644\u0648\u0646 \u0627\u0644\u062a\u0645\u064a\u0632',
            sidebarDensity: '\u0643\u062b\u0627\u0641\u0629 \u0627\u0644\u0634\u0631\u064a\u0637 \u0627\u0644\u062c\u0627\u0646\u0628\u064a',
            sidebarFontSize: '\u062d\u062c\u0645 \u062e\u0637 \u0627\u0644\u0634\u0631\u064a\u0637 \u0627\u0644\u062c\u0627\u0646\u0628\u064a',
