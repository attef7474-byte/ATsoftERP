...
const M: Record<string, ResourceDef> = {
  ...
  'inventory-valuation': { domain: 'inventory', ar: 'تقييم المخزون', en: 'Inventory Valuation' },
  ...
  'production-cost-overhead-allocation': { domain: 'production', ar: 'توزيع النفقات العامة', en: 'Overhead Allocation' },
...
const A: Record<string, ActionDef> = {
  ...
  'cost-input': { ar: 'إدخال التكلفة', en: 'Cost Input' },
  initialize: { ar: 'تهيئة', en: 'Initialize' },
