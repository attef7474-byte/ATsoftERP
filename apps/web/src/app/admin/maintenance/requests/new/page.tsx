...
import type { Machine, SparePart } from '../../../../../lib/admin-types';
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Input label={t('maintenance.title')} name="title" value={form.title} onChange={(e) => setField('title', e.target.value)} error={errors.title} required />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <F9Lookup label={t('maintenance.productionLine')} value={form.productionLineId} onChange={(v) => setField('productionLineId', v)} adapter={productionLineAdapter} disabled={Boolean(form.machineId)} />
              <F9Lookup label={t('maintenance.machineComponent')} value={form.machineComponentId} onChange={(v) => setField('machineComponentId', v)} adapter={machineComponentAdapter} filters={{ machineId: form.machineId }} disabled={!form.machineId} />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <F9Lookup label={t('maintenance.operationType')} value={form.operationTypeId} onChange={(v) => setField('operationTypeId', v)} adapter={operationTypeAdapter} disabled={Boolean(form.machineId)} />
              <F9Lookup label={t('maintenance.costCenter')} value={form.costCenterId} onChange={(v) => setField('costCenterId', v)} adapter={costCenterAdapter} disabled={Boolean(form.machineId)} />
            </div>
