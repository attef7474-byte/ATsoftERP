  ...
  return (
    <div>
      ...
      {!error && !loading && data.length > 0 && (
        <Card>
          <DataTable columns={columns} data={data} keyExtractor={(tk: MaintenanceTask) => tk.id} onRowClick={(item: MaintenanceTask) => setSelectedId(item.id)} selectedKey={selectedId} />
