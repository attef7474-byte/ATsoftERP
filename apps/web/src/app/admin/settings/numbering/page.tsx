...
export default function NumberingPage() {
  ...
  const baseColumns: GridColumn<any>[] = [
    ...
    { key: 'operationName', header: t('settings.numbering.operationName'), sortable: true, filterable: true, filterType: 'select', filterOptions: [
      ...
      { value: 'ADMINISTRATION', label: t('settings.numbering.operationNameMap.ADMINISTRATION') },
      ...
      { value: 'OPENING_BALANCE', label: t('settings.numbering.operationNameMap.OPENING_BALANCE') },
      { value: 'STOCK_ADJUSTMENT', label: t('settings.numbering.operationNameMap.STOCK_ADJUSTMENT') },
      { value: 'PHYSICAL_COUNT', label: t('settings.numbering.operationNameMap.PHYSICAL_COUNT') },
      { value: 'STOCK_TRANSFER', label: t('settings.numbering.operationNameMap.STOCK_TRANSFER') },
      { value: 'OPERATIONAL_RECEIPT', label: t('settings.numbering.operationNameMap.OPERATIONAL_RECEIPT') },
      ...
      { value: 'MACHINE_CATEGORY', label: t('settings.numbering.operationNameMap.MACHINE_CATEGORY') },
      ...
      { value: 'MAINTENANCE_PERSONNEL', label: t('settings.numbering.operationNameMap.MAINTENANCE_PERSONNEL') },
      ...
      { value: 'OPERATION_TYPE', label: t('settings.numbering.operationNameMap.OPERATION_TYPE') },
      { value: 'COST_CENTER', label: t('settings.numbering.operationNameMap.COST_CENTER') },
      { value: 'PRODUCTION_LINE', label: t('settings.numbering.operationNameMap.PRODUCTION_LINE') },
      { value: 'SPARE_PART', label: t('settings.numbering.operationNameMap.SPARE_PART') },
      { value: 'BARCODE_LABEL', label: t('settings.numbering.operationNameMap.BARCODE_LABEL') },
      { value: 'QR_LABEL', label: t('settings.numbering.operationNameMap.QR_LABEL') },
      { value: 'BARCODE_RECORD', label: t('settings.numbering.operationNameMap.BARCODE_RECORD') },
      { value: 'BARCODE_PRINT_JOB', label: t('settings.numbering.operationNameMap.BARCODE_PRINT_JOB') },
