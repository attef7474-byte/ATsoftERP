    ...
    <div>
      ...
      {kpis && (
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
          ...
          <Link href="/admin/notifications"><Card className="hover:shadow-md transition-shadow cursor-pointer"><CardContent><p className="text-xs text-gray-500">{t('dashboard.unreadNotifications')}</p><p className="text-xl font-bold text-pink-600">{kpis.unreadNotifications ?? '-'}</p></CardContent></Card></Link>
          <Link href="/admin/maintenance/requests?overdue=true"><Card className="hover:shadow-md transition-shadow cursor-pointer"><CardContent><p className="text-xs text-gray-500">{t('dashboard.slaOverdue')}</p><p className="text-xl font-bold text-red-600">{kpis.slaOverdue ?? '-'}</p></CardContent></Card></Link>
          <Link href="/admin/maintenance/requests?escalated=true"><Card className="hover:shadow-md transition-shadow cursor-pointer"><CardContent><p className="text-xs text-gray-500">{t('dashboard.slaEscalated')}</p><p className="text-xl font-bold text-amber-600">{kpis.slaEscalated ?? '-'}</p></CardContent></Card></Link>
