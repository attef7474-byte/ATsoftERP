export const NUMBERING_ENTITY_TYPES = {
  ...
  SPARE_PART_CONDITION_MOVEMENT: 'SPARE_PART_CONDITION_MOVEMENT',
  SPARE_PART_REPLACEMENT: 'SPARE_PART_REPLACEMENT',
  SPARE_PART_REPAIR_ORDER: 'SPARE_PART_REPAIR_ORDER',
  MAINTENANCE_BOM: 'MAINTENANCE_BOM',
  PREVENTIVE_SPARE_PART_PLAN: 'PREVENTIVE_SPARE_PART_PLAN',
} as const;
