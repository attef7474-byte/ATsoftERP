...
export class InventoryStockAdjustmentsController {
  ...
  updateLine(@Param('id') id: string, @Param('lineId') lineId: string, @Body() dto: UpdateStockAdjustmentLineDto, @CurrentUser('id') userId: string, @CurrentActiveContext() ctx: ActiveOperationalContext) {
