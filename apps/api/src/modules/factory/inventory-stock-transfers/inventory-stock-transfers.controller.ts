...
export class InventoryStockTransfersController {
  ...
  create(@Body() dto: CreateStockTransferDto, @CurrentUser('id') userId: string, @CurrentActiveContext() ctx: ActiveOperationalContext) {
  ...
  findAll(@Query() query: StockTransferQueryDto, @CurrentActiveContext() ctx: ActiveOperationalContext) {
  ...
  update(@Param('id') id: string, @Body() dto: UpdateStockTransferDto, @CurrentUser('id') userId: string, @CurrentActiveContext() ctx: ActiveOperationalContext) {
  ...
  addLine(@Param('id') id: string, @Body() dto: CreateStockTransferLineDto, @CurrentUser('id') userId: string, @CurrentActiveContext() ctx: ActiveOperationalContext) {
  ...
  updateLine(@Param('id') id: string, @Param('lineId') lineId: string, @Body() dto: Partial<CreateStockTransferLineDto>, @CurrentUser('id') userId: string, @CurrentActiveContext() ctx: ActiveOperationalContext) {
  ...
  availability(@Param('productId') productId: string, @Query('warehouseId') warehouseId: string, @CurrentActiveContext() ctx: ActiveOperationalContext) {
    return this.service.getAvailability(productId, warehouseId, ctx);
  }
}
