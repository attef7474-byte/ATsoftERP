...
export class ReportExportService {
  ...
  private async getReportData(endpoint: string, filters: any, ctx: ActiveOperationalContext): Promise<any> {
    switch (endpoint) {
      ...
      case 'inventory/overview': return this.dashboardReportsService.getInventoryOverview(filters, ctx);
      case 'inventory/balances': return this.inventoryReportsService.getInventoryBalanceReport(filters, ctx);
      case 'inventory/count-variance': return this.inventoryReportsService.getInventoryCountVarianceReport(filters, ctx);
      case 'inventory/movements': return this.inventoryReportsService.getInventoryMovementsReport(filters, ctx);
      case 'inventory/adjustments': return this.inventoryReportsService.getInventoryAdjustmentsReport(filters, ctx);
      case 'barcodes/scans': return this.barcodeReportsService.getBarcodeScansReport(filters, ctx);
      case 'assets': return this.systemReportsService.getAssetsRegisterReport(filters, ctx);
      case 'parts': return this.systemReportsService.getPartsReport(filters, ctx);
      case 'partners': return this.systemReportsService.getPartnersReport(filters, ctx);
      case 'attachments': return this.systemReportsService.getAttachmentsReport(filters, ctx);
      case 'audit': return this.auditReportsService.getAuditTrailReport(filters, ctx);
      case 'user-activity': return this.auditReportsService.getUserActivityReport(filters, ctx);
      case 'notifications': return this.auditReportsService.getNotificationsReport(filters, ctx);
      ...
      case 'low-stock': return this.systemReportsService.getLowStockReport(filters, ctx);
