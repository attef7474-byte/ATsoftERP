...
export class AppearanceService {
  ...
  async get() {
    ...
    return {
      ...
      accentColor: map['appearance.accentColor'] || '#14b8a6',
      primaryColor: map['appearance.primaryColor'] || '#2563eb',
      gradientStrength: map['appearance.gradientStrength'] || '70',
      gradientFocus: map['appearance.gradientFocus'] || 'BALANCED',
      gradientDirection: map['appearance.gradientDirection'] || 'BILATERAL_CENTER',
      preset: map['appearance.preset'] || 'REFERENCE_DEFAULT',
      fontScale: map['appearance.fontScale'] || 'medium',
      shadow: map['appearance.shadow'] || 'medium',
      radius: map['appearance.radius'] || 'medium',
      glassOpacity: map['appearance.glassOpacity'] || '0.72',
      glassBlur: map['appearance.glassBlur'] || '14',
